...
import org.indritbreti.restprocessordemo.exceptions.api.forbidden.ForbiddenException;
import org.indritbreti.restprocessordemo.util.Utilities;
...
public class AuthorizationFacade {
    ...
    public static boolean isAdminOnCurrentSecurityContext() {
        return org.indritbreti.restprocessordemo.util.Utilities.notNullAndContains(getCurrentSecurityContextAuthentication().getAuthorities(), ADMIN_AUTHORITY);
    }
    ...
    public static boolean isAdminOrCurrentUserOnCurrentSecurityContext(String username) {
        ...
        return org.indritbreti.restprocessordemo.util.Utilities.notNullAndContains(authentication.getAuthorities(), ADMIN_AUTHORITY) || (org.indritbreti.restprocessordemo.util.Utilities.notNullAndContains(authentication.getAuthorities(), ANONYMOUS_AUTHORITY) && authentication.getPrincipal().equals(username));
    }
