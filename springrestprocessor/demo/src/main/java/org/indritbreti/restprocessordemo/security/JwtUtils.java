...
import org.indritbreti.restprocessordemo.config.configProperties.JWTConfigProperties;
import org.indritbreti.restprocessordemo.exceptions.api.unauthorized.InvalidTokenException;
import org.indritbreti.restprocessordemo.exceptions.api.unauthorized.InvalidTokenTypeException;
import org.indritbreti.restprocessordemo.exceptions.api.unauthorized.InvalidTokenUserException;
...
import org.indritbreti.restprocessordemo.security.DTO.TokenPair;
...
public class JwtUtils implements Serializable {
    ...
    public TokenDetails getTokenDetailsFromAuthorizationHeader(String authorizationHeader, AppUserService appUserService){
        ...
        try {
            ...
            throw new org.indritbreti.restprocessordemo.exceptions.api.unauthorized.TokenExpiredException(exception);
